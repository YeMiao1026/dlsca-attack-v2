...
| E03（desync50，含 resync 前處理） | ID | 未跌破1，但趨勢完全收斂 | 訓練前先用互相關盲對齊校正時間抖動，第一次嘗試就大幅突破隨機基準，見附錄 B.29-B.31 |
| E04（desync100，含 resync 前處理） | ID | GE@10000=7.00（已結案，接受為誠實最佳結果） | 需要專屬四維度超參數調查，Attack 集 10000 條軌跡的評估窗口上限可能是瓶頸，見附錄 B.33-B.42 |
| E06（cnn_best） | ID, desync0 | 未收斂 | One-Cycle LR 對此架構完全無效（三個峰值跟flat基準無法區分），暫停，見附錄 B.43-B.44 |
