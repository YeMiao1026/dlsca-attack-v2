...
**目前desync100的假警報頻率明顯高於desync50**：B.34（epoch15, 67.65→146.58/181.53）、B.35 seed123（epoch40, 23.15→166.76）都是訓練期預覽大幅偏離正式結果的案例，desync50當年（B.24之外）沒有出現這麼誇張的偏離。這可能暗示 desync100 即使對齊修好了，殘留的雜訊或訓練不穩定性本身比 desync50 更嚴重，20-run快速預覽在這裡的採樣雜訊被放大了。gentle 重跑結果稍後補上。
